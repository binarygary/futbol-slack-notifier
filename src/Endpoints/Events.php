...
use BinaryGary\Futbol\Endpoints\Events\Launch_Collection;
use BinaryGary\Futbol\Endpoints\Events\Help;
use BinaryGary\Futbol\Post_Types\Slack_Team;
...
class Events extends Base {
	...
	public function process( \WP_REST_Request $data ) {
		...
		$args = [
			...
			'post_status'  => 'publish',
			'post_type'    => \BinaryGary\Futbol\Post_Types\Events::NAME,
